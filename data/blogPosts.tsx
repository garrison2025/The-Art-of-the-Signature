        ...
        content: (
            <>
                ...
                <ul className="list-disc pl-6 space-y-4 mb-8 text-slate-600 dark:text-slate-300">
                    <li>
                        <strong>Wet Ink Signature:</strong> The traditional method. Pen on paper. It requires physical presence or mailing documents, which is inefficient in 2025.
                    </li>
                    <li>
                        <strong>Electronic Signature (E-Signature):</strong> This is any electronic sound, symbol, or process attached to a contract. This includes the high-quality PNG images generated by <a href="https://handwrittensignaturegenerator.org" className="text-blue-600 hover:underline">SignCraft</a>. In many jurisdictions, including under the US ESIGN Act, these are legally binding for most business transactions.
                    </li>
                    <li>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <li className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-slate-700">
                        ...
                        Choose styles ranging from "CEO Scribble" (fast, illegible, authoritative) to "Elegant Calligraphy".
                    </li>
                </ul>
