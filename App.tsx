...
function App() {
    ...
    switch (currentView) {
      ...
      default:
        return (
          <>
            {/* Hero Section */}
            <div className="relative pt-24 pb-36 px-6 text-center animate-fade-in">
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-slate-900 font-sans selection:bg-slate-200 flex flex-col justify-between">
