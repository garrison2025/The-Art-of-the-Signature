...
const Privacy: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 animate-fade-in text-slate-600">
      <h1 className="text-4xl font-serif text-slate-900 mb-2">Privacy Policy</h1>
      <p className="text-sm text-slate-400 mb-10">Last Updated: December 5, 2025</p>
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <h2 className="text-2xl font-serif text-slate-900 mt-8 mb-4">1. Client-Side Processing</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-serif text-slate-900 mt-8 mb-4">2. Log Files</h2>
        <p className="mb-6">
          SignCraft follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.
        </p>

        <h2 className="text-2xl font-serif text-slate-900 mt-8 mb-4">3. Cookies and Web Beacons</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-serif text-slate-900 mt-8 mb-4">4. Third Party Privacy Policies</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-serif text-slate-900 mt-8 mb-4">5. Contact Information</h2>
        <p className="mb-6">
          If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at <a href="mailto:info@handwrittensignaturegenerator.org" className="text-blue-600 hover:underline">info@handwrittensignaturegenerator.org</a>.
        </p>
      </div>
    </div>
  );
